...
const gCodesLoad = [];
gCodes.forEach(e => gCodesLoad.push('https://www.googletagmanager.com/gtag/js?id=' + e.id));
loadjs(gCodesLoad, 'G-Codes');
loadjs.ready("G-Codes", function() {
    function n() {
        dataLayer.push(arguments)
    }
    window.dataLayer = window.dataLayer || [], n("js", new Date), gCodes.forEach(a => {
        "GA" == a.type ? n("config", a.id) : "AD" == a.type && n("config", a.id, {
