...
$('.enqModal').click(function() {
    ...
    if (!isNonRera) {
        $('#enqModal .modal-title').html('Enquire Now');
        $('#enqModal .micro-form-btn').text('Enquire Now');
    }
    if (isNonRera) {
        $('#enqModal .modal-title').html("Express Your Interest");
        $('#enqModal .micro-form-btn').text("Express Your Interest");
    }
    if (isSyndicate) {
    ...
    if (Type == "sm" || Type == "md" || Type == "lg") {
        ...
        $('#enqModal .modal-logo, #enqModal .modal-call-btn, .auto-offer').addClass('d-none');
...
$(".intTelInput").keyup(function() {
    ...
    if (contryCode == null) {
        ...
        $(':input[name=iso_code]').val('+' + contryCode);
        $(':input[name=mobileExt]').val($('#' + intTelInputId).intlTelInput('getSelectedCountryData').iso2.toUpperCase());
    }
});
